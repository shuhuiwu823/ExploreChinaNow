    ...
    <div className="profile-container">
      <div className="blogs-section">
        ...
        {loadingBlogs ? (
          ...
          userBlogs.map((blog) => {
            const isExpanded = expandedBlogs[blog.id] || false; // Get the expanded state for this blog
      ...
      <div className="context-container">
        <img className="context-avatar" src={userData.avatar} alt={userData.username} />
        <div className="context-info" data-label="Username:">{userData.username}</div>
        <div className="context-info" data-label="E-mail:">{userData.email}</div>
        <div className="context-info" data-label="Name:">{userData.name}</div>
      </div>
    </div>
  );
}
