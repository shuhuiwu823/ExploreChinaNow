...
describe('Plan Component', () => {
  ...
  /* Test Case 5: Test the behavior when there are no saved plans in the database */
  test('test the behavior when there are no saved plans in the database', async () => {
    const mockUserData = { id: '123', name: 'Test User' };
    getDocs.mockResolvedValueOnce({
      docs: [], 
    });
  ...
  test('test the behavior when the user is not logged in', () => {
    render(
      <Router>
